...
def parse_args():
    ...
    parser.add_argument('--seg-num', type=int, default=3)
    parser.add_argument('--seg-len', type=int, default=15)
    ...
    while b_idx <= args.max_iters:
        ...
        for train_obs_list in train_loader:
            ...
            if b_idx % 100 == 0:
                ...
                post_test_init_data_list = postprocess(pre_test_init_data_list, args.obs_bit, device_idx)
                pre_test_input_data_list = pre_test_full_data_list[:, init_size:(init_size + seq_size)]
                post_test_input_data_list = postprocess(pre_test_input_data_list, args.obs_bit, device_idx)
                ...
                with torch.no_grad():
                    ...
                    post_test_rec_data_list = postprocess(results['rec_data'], args.obs_bit, device_idx)
                    ...
                    post_test_gen_data_list = postprocess(pre_test_gen_data_list, args.obs_bit, device_idx)
